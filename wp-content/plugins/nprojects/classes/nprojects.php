...
final class nProjects extends nProjects_Base
{
	...
	public function register_post_types() {
		register_post_type( self::TYPE_NAME,
			apply_filters( 'nprojects/post_type_args', array(
				'labels'             => array(
		 ...
		 */
		register_taxonomy( self::TYPE_CATEGORY, self::TYPE_NAME,
			apply_filters( 'nprojects/taxonomy_category_args', array(
				'labels'            => array(
		 ...
		 * Register category taxonomy
		 */
		register_taxonomy( self::TYPE_TAG, self::TYPE_NAME,
			apply_filters( 'nprojects/taxonomy_tag_args', array(
				'labels'            => array(
