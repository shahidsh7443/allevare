...
$links = paginate_links( array(
	...
	'prev_text' => esc_html__( '&larr; Previous', 'cosine' ),
	'next_text' => esc_html__( 'Next &rarr;', 'cosine' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next &rarr;', 'cosine' ) );
$prev_link = get_previous_posts_link( esc_html__( '&larr; Previous', 'cosine' ) );
$more_link = get_next_posts_link( esc_html__( 'Load More', 'cosine' ) );
