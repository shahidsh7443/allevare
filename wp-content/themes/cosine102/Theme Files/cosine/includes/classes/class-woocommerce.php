 ...
 */
class Cosine_Woocommerce extends Cosine_Feature
{
	/**
	...
	public function customize_sections( $sections ) {
		$sections[ 'woocommerce' ] = array(
			'title'       => esc_html__( 'WooCommerce', 'cosine' ),
			'description' => '',
			'priority'    => 10
		);
	...
	public function customize_controls( $controls ) {
		$controls[ 'woocommerce_archive_heading' ] = array(
			'type'        => 'heading',
			'section'     => 'woocommerce',
			'title'       => esc_html__( 'Products Listing', 'cosine' ),
			'description' => esc_html__( 'This section is designed for only Woocommerce, it will be applied for page that listing all products.', 'cosine' )
		);
		...
		$controls[ 'woocommerce_archive_sidebar' ] = array(
			...
			'section' => 'woocommerce',
			'label'   => esc_html__( 'Sidebar', 'cosine' ),
		...
		$controls[ 'woocommerce_products_per_page' ] = array(
			'type'    => 'spinner',
			'section' => 'woocommerce',
			'label'   => esc_html__( 'Products Per Page', 'cosine' ),
			'default' => 10,
			'min'     => 1
		);
		...
		$controls[ 'woocommerce_details_heading' ] = array(
			'type'        => 'heading',
			'section'     => 'woocommerce',
			'title'       => esc_html__( 'Product Details', 'cosine' ),
			'description' => esc_html__( 'Like "Blog Single" section, you can change style for product details page.', 'cosine' )
		);
		...
		$controls[ 'woocommerce_related_box_enabled' ] = array(
			'type'    => 'switcher',
			'label'   => esc_html__( 'Show Related Products', 'cosine' ),
			'section' => 'woocommerce',
			'default' => true
		);
		...
		$controls[ 'woocommerce_related_products_count' ] = array(
			'type'    => 'spinner',
			'section' => 'woocommerce',
			'label'   => esc_html__( 'Number Of Related Products', 'cosine' ),
			'min'     => 1,
			'default' => 4
		);
