 ...
 */
class Cosine extends Cosine_Base
{
	const VERSION = '1.0.0';
	const SLUG    = 'cosine';
	...
	protected function __construct() {
		 ...
		 */
		add_action( 'template_include', 'Cosine_Wrapper::wrap' );
	...
	protected function setup_menus() {
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'cosine' ),
			'top'     => esc_html__( 'Top Menu', 'cosine' )
		) );
	}
	...
	protected function setup_sidebars() {
		register_sidebar( array(
			'name'          => esc_html__( 'Primary Sidebar', 'cosine' ),
			'id'            => 'sidebar-primary',
			'description'   => '',
		...
		// Header Widgets
		register_sidebar( array(
			'name'          => esc_html__( 'Header Sidebar', 'cosine' ),
			'id'            => 'header-widgets',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		// Footer Sidebars
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #1', 'cosine' ),
			'id'            => 'footer-1',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #2', 'cosine' ),
			'id'            => 'footer-2',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #3', 'cosine' ),
			'id'            => 'footer-3',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #4', 'cosine' ),
			'id'            => 'footer-4',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #1', 'cosine' ),
			'id'            => 'content-bottom-1',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #2', 'cosine' ),
			'id'            => 'content-bottom-2',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #3', 'cosine' ),
			'id'            => 'content-bottom-3',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #4', 'cosine' ),
			'id'            => 'content-bottom-4',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
	...
	protected function setup_features() {
		 ...
		 */
		Cosine_ThemeCustomize::instance();

		/**
		 * Initialize custom sidebars manager
		 */
		Cosine_Sidebars::instance();
		
		/**
		 * Initialize theme breadcrumb
		 */
		Cosine_Breadcrumb::instance();	

		/**
		 * Initialize search feature
		 */
		Cosine_Search::instance();

		/**
		 * Initialize support for WooCommerce
		 */
		Cosine_Woocommerce::instance();

		/**
		 * Initialize support for Projects
		 */
		Cosine_Projects::instance();
	}
}
