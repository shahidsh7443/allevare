...
if ( ! function_exists( 'cosine_post_title' ) ) {
	/**
	 * Display the post title
	 * 
	 * @return  void
	 */
	function cosine_post_title() {
...
if ( ! function_exists( 'cosine_post_meta' ) ) {
	/**
	 * Display the post meta
	 * 
	 * @return  void
	 */
	function cosine_post_meta() {
		...
		?>
			...
			<div class="entry-meta">
				...
				<span class="entry-categories">
					<?php the_category( _x( ', ', 'Used between list items, there is a space after the comma.', 'cosine' ) ); ?>
				</span>
				...
				<?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
					...
					<?php else: ?>
						...
						<span class="entry-comments-link">
							<?php comments_popup_link( esc_html__( '0 Comment', 'cosine' ), esc_html__( '1 Comment', 'cosine' ), esc_html__( '% Comments', 'cosine' ) ); ?>
						</span>
...
if ( ! function_exists( 'cosine_post_content' ) ) {
	/**
	 * Display the post content
	 * 
	 * @return  void
	 */
	function cosine_post_content() {
